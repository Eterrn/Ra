...
<<<<<<<<<<<<<<<<<<>>>>>>>>>iM2ortaL<<<<<<<<<<>>>>>>>>>>>>>>>>>>
    ...
    / __| |\ \        | |        | |  | |  | |\ \    | |
   / /  | | \ \    _  | |_____   | |__| |  | | \ \   | |
  /_/   |_|  \_\  |_| \_______|  \______/  |_|  \_\  |_|

\033[1;91m\033[1;41m\033[1;97m Author: By Eterrn\033[;0m\033[1;91m\033[1;92m
""")
    except requests.exceptions.ConnectionError:
        sys.exit(f"{W}[{R}!{W}] Eror Connection{abu}....{abu}")
...
def put():
    ...
    try:
        ...
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m INPUT Number \033[1;33m• \033[0m\033[1;30m]══════════════>")
        mengetik("\033[37m[\033[31m•\033[37m]\033[32m Example \033[37m : \033[37m\033[33m8*****\033[33m")
        mr_am=input(f"\n\033[37m[\033[31m•\033[37m]\033[32m Target Number\033[32m \033[37m:\033[37m\033[33m ")
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m Free amount \033[1;33m• \033[0m\033[1;30m]═════════════>")
        power_python=int(input(f"\033[37m[\033[31m•\033[37m]\033[32m Total Spam\033[37m :\033[37m\033[33m "))
        print ("")
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                mengetik(f"{W}[{G}✓{W}] Send Spam Call to No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{R}×{W}] Failed Spam Call to No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "Berhasil Ngab" in gas:
                mengetik(f"{W}[{R}×{W}] Failed Sending Spam WA to No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Sending Spam WA to No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "ok" in dekor2:
                mengetik(f"{W}[{G}✓{W}] Sending Spam Sms to No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{R}×{W}] Failed Spam Sms to No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "neng" in buka:
                mengetik(f"{W}[{R}×{W}] Failed Mengirim Spam WA to No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Sending Spam WA to No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "PENDING" in AmmarGamteng:
                ...
                mengetik(f"{W}[{R}×{W}] Failed Spam Sms to No {Y}{mr_am}{W}")
            time.sleep(1)
            ...
            if "coi" in coi:
                mengetik(f"{W}[{R}×{W}] Failed  Spam WA to ke {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Sending Spam WA to ke {Y}{mr_am}")
            time.sleep(1)
            ...
            if "send" in gw:
                mengetik(f"{W}[{R}×{W}] Failed Spam WA to No {Y}{mr_am}")
            else:
                mengetik(f"{W}[{G}✓{W}] Sending Spam WA to No {Y}{mr_am}")
            time.sleep(1)
        ...
        sys.exit(f"{W}[{R}!{W}] Error Network Bro{abu}....{abu}")
    except KeyboardInterrupt:
